...
## Game Vizualisation
Clone this repository https://github.com/Tientjie-san/quoridorWGUI
and follow the instructions as stated in the ReadME.md. 
The pgn's generated by this project can be used to vizualise the game.

```
git clone https://github.com/Tientjie-san/quoridorWGUI.git
```
